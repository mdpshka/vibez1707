...
from onboarding import register_onboarding, OnboardingStates  # ИСПРАВЛЕНО: добавлен импорт OnboardingStates
    ...
    if len(args) > 1 and args[1].startswith("invite_"):
        try:
            ...
            if not onboarded:
                ...
                await state.set_state(OnboardingStates.NAME)  # ИСПРАВЛЕНО: используем объект состояния
